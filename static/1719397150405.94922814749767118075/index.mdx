...
p_type: "projects"
title: "X Transit Hub"
title_sub: " Walkability Model Using Dynamic Multilayer Method in Transit Hub Design"

slug: "x-transit-hub"

hero_img_src: "./figures/x-transit-hub-thumbnail-color.jpg"
hero_img_alt: "X Transit Hub"
...
pr_adv: "Aswin Indraprastha"
pr_jury: "M. Donny Koerniawan & Heru W. Poerbo"
...
---
# Design
<ImgDefa>![Perspective](./figures/x-transit-hub-pers.jpg "Perspective")</ImgDefa>
<FigCpt>Perspective.</FigCpt>

<ImgInv>![Section A-A](./figures/x-transit-hub-section-aa.jpg "Section A-A")</ImgInv>
<FigCpt>Section A-A.</FigCpt>

<ImgInv>![Section B-B](./figures/x-transit-hub-section-bb.jpg "Section B-B")</ImgInv>
<FigCpt>Section B-B.</FigCpt>

<ImgInv>![Exploded axonometric](./figures/x-transit-hub-exploded-axonometric.jpg "Exploded axonometric")</ImgInv>
<FigCpt>Exploded axonometric.</FigCpt>

# Methodology
<ImgInv>![DML method framework](./figures/x-transit-hub-methodology.jpg "DML method framework")</ImgInv>
<FigCpt>DML method framework.</FigCpt>
...
<ImgInv> ![The taxonomy of routes in Kalideres](./figures/x-transit-hub-routes-taxonomy.jpg "The taxonomy of routes in Kalideres is based on traffic observations and pivotal variables, creating route segmentation.")</ImgInv>
<FigCpt>The taxonomy of routes in Kalideres is based on traffic observations and pivotal variables, creating route segmentation.</FigCpt>

<ImgInv>![Route scoring](./figures/x-transit-hub-routes-scoring.jpg "Route scoring is based on route segmentation.")</ImgInv>
<FigCpt>Route scoring is based on route segmentation.</FigCpt>

<ImgInv>![Point-map with agents and targets point](./figures/x-transit-hub-point-map-agent-based.jpg "Point-map with agents (AR, AT) and targets (T1,T2).")</ImgInv>
<FigCpt>Point-map with agents (AR, AT) and targets (T1,T2).</FigCpt>
...
<ImgInv>![Aggregated results from agent-based simulations in Iterations 1, 2, and 3](./figures/x-transit-hub-abm-superimpose.jpg "Aggregated results from agent-based simulations in Iterations 1, 2, and 3, illustrating crowd movement in the virtual environment.")</ImgInv>
<FigCpt>Aggregated results from agent-based simulations in Iterations 1, 2, and 3, illustrating crowd movement in the virtual environment.</FigCpt>

<TblWrp id="table1">
  <TblCpt>Solo Commuting, Solo Walking, Group Touring</TblCpt>
  <thead>
    <tr>
      <th>Solo Commuting (Iteration 1)</th>
      <th>Solo Walking (Iteration 2)</th>
      <th>Group Touring (Iteration 3)</th>
    </tr>
  </thead>
  ...
  <tbody>
    <tr>
      <td>
        Designed for students and working professionals, this configuration
        activates Wandering while deactivating Align Force.
      </td>
      <td>
        Tailored for leisure walkers, this configuration deactivates both
        Wandering and Align Force.
      </td>
      <td>
        Configured for group tours, this setup deactivates Wandering and
        activates Align Force.
      </td>
    </tr>
  </tbody>
</TblWrp>
...
<ImgInv>![Simplifying the Trails](./figures/x-transit-hub-ls.jpg "Simplifying the Trails")</ImgInv>
<FigCpt>Simplifying the Trails.</FigCpt>

<VidRmt
  src="https://youtube.com/embed/NKD823bFDhM"
  title="Simplifying the Trails"
  videoUrl="https://youtube.com/watch?v=NKD823bFDhM"
/>
...
<ImgInv>![Defining the Objectives: Shortest path algorithm (A-star)](./figures/x-transit-hub-spa.jpg "Defining the Objectives: Shortest path algorithm (A-star)")</ImgInv>

<VidRmt
  src="https://youtube.com/embed/DrelgFFXo6g"
  title="Defining the Objectives"
  videoUrl="https://youtube.com/watch?v=DrelgFFXo6g"
/>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <div>
    <ImgInv>![Diamond Fitness Chart (DFC) traces optimization progress](./figures/x-transit-hub-moo-dfc.jpg "Diamond Fitness Chart (DFC) traces optimization progress.")</ImgInv>
    <FigCpt>Diamond Fitness Chart (DFC) traces optimization progress.</FigCpt>
  </div>
  <div>
    <ImgInv>![PCP, FVG, SDG, and SDT offer a comprehensive view of generation.](./figures/x-transit-hub-moo-graph.jpg "PCP, FVG, SDG, and SDT offer a comprehensive view of generation.")</ImgInv>
    <FigCpt>PCP, FVG, SDG, and SDT offer a comprehensive view of generation.</FigCpt>
  </div>
</div>

<ImgInv>![Optimizing the Objectives](./figures/x-transit-hub-moo-process.jpg "Optimizing the Objectives")</ImgInv>
<FigCpt>Optimizing the Objectives.</FigCpt>

<VidRmt
  src="https://youtube.com/embed/7_Oj2FQFB4A"
  title="Optimizing the Objectives"
  videoUrl="https://youtube.com/watch?v=7_Oj2FQFB4A"
/>
...
<ImgInv>![Clustering method](./figures/x-transit-hub-clustering-method.jpg "A method for clustering the set of solutions into the best solution. It is called the Selection Clustering (SC) method.")</ImgInv>
<FigCpt>A method for clustering the set of solutions into the best solution. It is called the Selection Clustering (SC) method.</FigCpt>
...
<ImgInv>![Best solution](./figures/x-transit-hub-best-solution.jpg "Best solution")</ImgInv>
<FigCpt>Best Solution.</FigCpt>
...
# Media
<VidRmt src="https://youtube.com/embed/1Eei2f9kM_Y" title="3D Walkthrough" videoUrl="https://youtube.com/watch?v=1Eei2f9kM_Y"/>