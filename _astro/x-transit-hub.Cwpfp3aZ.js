...
`,r={hero_img_src:new Proxy({src:"/_astro/x-transit-hub-thumbnail.BDRAATwZ.jpg",width:2048,height:2048,format:"jpg",fsPath:"D:/izvw/github/astro/mad-jet/src/content/projects/2023/x-transit-hub/figures/x-transit-hub-thumbnail.jpg"},{get(e,t,n){return t==="clone"?structuredClone(e):t==="fsPath"?"D:/izvw/github/astro/mad-jet/src/content/projects/2023/x-transit-hub/figures/x-transit-hub-thumbnail.jpg":(e[t]!==void 0&&globalThis.astroAsset&&globalThis.astroAsset?.referencedImages.add("D:/izvw/github/astro/mad-jet/src/content/projects/2023/x-transit-hub/figures/x-transit-hub-thumbnail.jpg"),e[t])}}),post_type:"projects",pub_date:"2023-01-25",main_title:"X Transit Hub",abstract:"This thesis delves into the challenges, methodologies, and solutions associated with the design of a transit hub (TH) in Jakarta that integrates both public transportation and public spaces (PS). A Dynamic Multi-Layer (DML) method addresses these intricate challenges by examining traffic density, simulating pedestrian movements, and optimizing for multiple objectives, such as minimizing distance to PS and reducing the total number of PS. The ultimate solution serves as a blueprint for the TH design, emphasizing human mobility, connectivity, and greenery.",subtitle:" Walkability Model Using Dynamic Multilayer Method in Transit Hub Design",location:"West Jakarta, Indonesia",classification:"Master’s Thesis",project_details:"Individual work",contributions:[],jury:["M. Donny Koerniawan","Heru W. Poerbo"],instructor:[],team_leader:[],advisor:["Aswin Indraprastha"],hero_img_alt:"X Transit Hub",keywords:["Urban research","Transit design","Public space","Computation","Design methods","Design optimization"],softwares:["Rhino","Grasshopper","Wallacei","Culebra","Quelea","Anemone","Caribou","Arachne","Kangaroo 2","Twinmotion","Adobe Photoshop","Simplify3D","UltiMaker Cura"],authors:[],courseworks:["Thesis"],editors:[]},d={type:"content",filePath:"D:/izvw/github/astro/mad-jet/src/content/projects/2023/x-transit-hub/x-transit-hub.mdx",rawData:void 0};export{d as _internal,a as body,o as collection,r as data,i as id,s as slug};
