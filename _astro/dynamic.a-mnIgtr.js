...
\r
{/* prettier-ignore */}\r
<MarkdownImage id="fig1" src={fig1} w50>Demand for TransJakarta buses in Jakarta, depicting daily passenger statistics of 8,632 on buses, sourced from the Pedestrian Facility Design Guidelines DKI Jakarta 2017–2022 by ITDP [^67].</MarkdownImage>\r
\r
...
\r
{/* prettier-ignore */}\r
<MarkdownImage id="fig2" src={fig2} w50>The satellite view of the Kalideres region highlights a significant traffic bottleneck in the highlighted area, with base satellite imagery sourced from Google Maps [^72]. Details labeled as (a) and (b) are shown in <MarkdownCrossRefFigure i={3} />.</MarkdownImage>\r
\r
...
\r
<MarkdownImage id="fig4" src={fig4} title="The framework of the dynamic multi-layer (DML) method." isInvert w50 />\r
\r
...
\r
<MarkdownImage id="fig5" src={fig5} title="The taxonomy of routes in Kalideres, based on traffic movement in field walkability observations." isInvert w50 />\r
\r
...
\r
<MarkdownImage id="fig6" src={fig6} title="(a) Graphical representations of route segments based on ranking metrics; (b) an ABMS point map with agents (AR, AT) and targets (T1, T2)." isInvert w50 />\r
\r
...
\r
<MarkdownImage id="fig7" src={fig7} title="Aggregated results from Iterations 1, 2, and 3." isInvert w50 />\r
\r
...
\r
<MarkdownImage id="fig8" src={fig8} title="Iterative curve trail-smoothing stages, with the selected 10th iteration highlighted by a dashed border." isInvert w50 pagefindMeta />\r
\r
...
\r
<MarkdownImage id="fig9" src={fig9} title="Iteration process for the shortest path from Layer 3’s trails." isInvert w50 />\r
\r
...
\r
<MarkdownImage id="fig10" src={fig10} title="Representative samples of solutions with Diamond Fitness Charts (DFC) in the top-right corner of each solution." isInvert w50 />\r
\r
...
\r
<MarkdownImage id="fig11" src={fig11} title="Simulation results featuring (a) PCP visualization, (b) Pareto front of 2,500 solutions, and (c) comprehensive graphs illustrating FO1–FO5 across FVG, SDG, and SDT." isInvert w50 />\r
\r
## Layer 6: Clustering & selecting the best solution\r
\r
<MarkdownImage id="fig12" src={fig12} title="Framework of the iterative solution optimization approach (ISOA)." isInvert w50 />\r
\r
...
\r
<MarkdownImage id="fig13" src={fig13} title="K-means clustering of all generations." w50 />\r
\r
...
\r
<MarkdownImage id="fig15" src={fig15} title="Map legend for PS coordinates and associated variables in Iter₈ and Iter₉." isInvert w50 />\r
\r
...
\r
<MarkdownImage id="fig16" src={fig16} title="Clustering process in Iter₇ based on custom weight formula for each FO." isInvert w50 />\r
\r
