...
<MarkdownGrid t50>
  <MarkdownImage parentType="t50" src={fig01} noPadding />
  <MarkdownImage parentType="t50" src={fig02} noPadding />
</MarkdownGrid>

# Voxel Space 2

<MarkdownGrid t50>
  <MarkdownImage parentType="t50" src={fig03} noPadding />
  <MarkdownImage parentType="t50" src={fig04} noPadding />
</MarkdownGrid>

# Voxel Space 3

<MarkdownGrid t50>
  <MarkdownImage parentType="t50" src={fig05} noPadding />
  <MarkdownImage parentType="t50" src={fig06} noPadding />
</MarkdownGrid>

# Voxel Space 4

<MarkdownGrid t50>
  <MarkdownImage parentType="t50" src={fig07} noPadding />
  <MarkdownImage parentType="t50" src={fig08} noPadding />
</MarkdownGrid>
`,i={hero_img_src:new Proxy({src:"/_astro/voxel-space-01.CkZ_1WC8.png",width:1280,height:1280,format:"png",fsPath:"D:/izvw/github/astro/mad-jet/src/content/models/2023/voxel-space/figures/voxel-space-01.png"},{get(o,e,s){return e==="clone"?structuredClone(o):e==="fsPath"?"D:/izvw/github/astro/mad-jet/src/content/models/2023/voxel-space/figures/voxel-space-01.png":(o[e]!==void 0&&globalThis.astroAsset&&globalThis.astroAsset?.referencedImages.add("D:/izvw/github/astro/mad-jet/src/content/models/2023/voxel-space/figures/voxel-space-01.png"),o[e])}}),post_type:"models",pub_date:"2023-09",main_title:"Voxel Space",contributions:[],jury:[],instructor:[],team_leader:[],advisor:[],hero_img_alt:"Voxel Space",keywords:["Algorithmic design","Computational thinking","Design exploration","Generative design","Voxel Space"],softwares:[],authors:[],courseworks:[],editors:[]},p={type:"content",filePath:"D:/izvw/github/astro/mad-jet/src/content/models/2023/voxel-space/voxel-space.mdx",rawData:void 0};export{p as _internal,a as body,r as collection,i as data,n as id,t as slug};
