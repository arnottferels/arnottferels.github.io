const n="2017/tkimai-33-umn/tkimai-33-umn.mdx",a="news",o="2017/07/28/indonesian-architecture-students-provide-public-space-solutions-with-bamboo-touches",r=`
import tkimai_33_umn_01 from './figures/tkimai-33-umn-01.jpg';
import tkimai_33_umn_02 from './figures/tkimai-33-umn-02.jpg';
import tkimai_33_umn_03 from './figures/tkimai-33-umn-03.jpg';
import tkimai_33_umn_04 from './figures/tkimai-33-umn-04.jpg';
import tkimai_33_umn_05 from './figures/tkimai-33-umn-05.jpg';
import tkimai_33_umn_06 from './figures/tkimai-33-umn-06.jpg';
import tkimai_33_umn_07 from './figures/tkimai-33-umn-07.jpg';
import tkimai_33_umn_08 from './figures/tkimai-33-umn-08.jpg';
import tkimai_33_umn_09 from './figures/tkimai-33-umn-09.jpg';
import tkimai_33_umn_10 from './figures/tkimai-33-umn-10.jpg';
import tkimai_33_umn_11 from './figures/tkimai-33-umn-11.jpg';
import tkimai_33_umn_12 from './figures/tkimai-33-umn-12.jpg';

import tkimai_33_umn_video_01 from './figures/tkimai-33-umn-video-01.mp4';
import tkimai_33_umn_video_02 from './figures/tkimai-33-umn-video-02.mp4';
...
<MarkdownImage src={tkimai_33_umn_01} text="Two bamboo installation artworks competed in the Urban Intervention Workshop as part of the 33rd Indonesian Architecture Student Scientific Meeting (TKI-MAI), held at Multimedia Nusantara University from Monday (7/24) to Friday (7/28)" w50 noPadding />
...
<MarkdownImage src={tkimai_33_umn_02} text="The atmosphere of creating bamboo installation artworks during the Urban Intervention Workshop, which is part of the TKI-MAI 33 Jakarta series of events held at UMN" w50 noPadding />
...
<MarkdownImage src={tkimai_33_umn_03} text="The atmosphere of creating bamboo installation artworks during the Urban Intervention Workshop, which is part of the TKI-MAI 33 Jakarta series of events held at UMN" w50 noPadding />
...
<MarkdownImage src={tkimai_33_umn_04} text="The atmosphere of creating bamboo installation artworks during the Urban Intervention Workshop, which is part of the TKI-MAI 33 Jakarta series of events held at UMN" w50 noPadding />
...
<MarkdownGrid t50>
  <MarkdownLocalVideo srcVid={tkimai_33_umn_video_01} title="TKI-MAI 33: Bamboo Workshop" />
  <MarkdownLocalVideo srcVid={tkimai_33_umn_video_02} title="TKI-MAI 33: Bamboo Workshop" />
</MarkdownGrid>

## Photos

<MarkdownGrid t25>
  <MarkdownImage parentType="t25" src={tkimai_33_umn_05} noPadding />
  <MarkdownImage parentType="t25" src={tkimai_33_umn_06} noPadding />
  <MarkdownImage parentType="t25" src={tkimai_33_umn_07} noPadding />
  <MarkdownImage parentType="t25" src={tkimai_33_umn_08} noPadding />
  <MarkdownImage parentType="t25" src={tkimai_33_umn_09} noPadding />
  <MarkdownImage parentType="t25" src={tkimai_33_umn_10} noPadding />
  <MarkdownImage parentType="t25" src={tkimai_33_umn_11} noPadding />
  <MarkdownImage parentType="t25" src={tkimai_33_umn_12} noPadding />
</MarkdownGrid>
`,s={hero_img_src:new Proxy({src:"/_astro/tkimai-33-umn-01.BWyDiA6a.jpg",width:1920,height:853,format:"jpg",fsPath:"D:/izvw/github/astro/mad-jet/src/content/news/2017/tkimai-33-umn/figures/tkimai-33-umn-01.jpg"},{get(i,t,e){return t==="clone"?structuredClone(i):t==="fsPath"?"D:/izvw/github/astro/mad-jet/src/content/news/2017/tkimai-33-umn/figures/tkimai-33-umn-01.jpg":(i[t]!==void 0&&globalThis.astroAsset&&globalThis.astroAsset?.referencedImages.add("D:/izvw/github/astro/mad-jet/src/content/news/2017/tkimai-33-umn/figures/tkimai-33-umn-01.jpg"),i[t])}}),post_type:"news",pub_date:"2017-07-28",main_title:"Indonesian Architecture Students Provide Public Space Solutions with Bamboo Touches",abstract:"I and other Indonesian architecture students gathered at UMN for the TKI-MAI 33 Urban Intervention Workshop, focusing on bamboo installations to enhance public spaces. The event aimed to foster creativity and sustainability in architecture, showcasing innovative uses of bamboo for ecological building solutions.",contributions:[],jury:[],instructor:[],team_leader:[],advisor:[],url:"https://www.umn.ac.id/mahasiswa-arsitektur-indonesia-berikan-solusi-public-space-lewat-sentuhan-bambu/",publisher:"Multimedia Nusantara University",keywords:["TKI MAI 33","Bamboo installation","Bamboo workshop"],softwares:[],authors:["Grace Natali"],courseworks:[],editors:[]},d={type:"content",filePath:"D:/izvw/github/astro/mad-jet/src/content/news/2017/tkimai-33-umn/tkimai-33-umn.mdx",rawData:void 0};export{d as _internal,r as body,a as collection,s as data,n as id,o as slug};
