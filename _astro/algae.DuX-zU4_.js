const e="2019/algae/algae.mdx",i="projects",d="algae-bio-facade-system",o=`
...
<MarkdownGrid t50>
  <MarkdownImage parentType="t50" text="Step 1 – The structure’s design follows local climate rules and building codes" src={features_01} isInvert />
  <MarkdownImage parentType="t50" text="Step 2 – It adjusts to microclimates, using passive strategies for changes based on sun and wind patterns" src={features_02} isInvert />
  <MarkdownImage parentType="t50" text="Step 3 – The building is mainly for offices, with co-working and retail as secondary functions" src={features_03} isInvert />
  <MarkdownImage parentType="t50" text="Step 4 – Design details involve placing algae façade modules and other materials" src={features_04} isInvert />
</MarkdownGrid>
